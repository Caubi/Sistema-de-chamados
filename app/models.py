...
class Maquina(models.Model):
    ESTADO_CHOICES = (
        ("Tela queimada", "Tela queimada"),("Mancha na tela", "Mancha na tela"),
        ("Barulho no cooler", "Barulho no cooler"),("Não liga", "Não liga"),
        ...
        ("Problema na entrada usb", "Problema na entrada usb"),("Tela quebrada", "Tela quebrada"),
    )
...
class Chamado(models.Model):
    ...
    date_saida = models.DateField(blank=True, verbose_name="Data da baixa")
